...
<html lang="en">
  <head>
    ...
    <script type="module" defer src="public/script.js"></script>
    <script type="module" defer src="public/components/login/login.js"></script>
    <script type="module" defer src="public/components/menu/menu.js"></script>
    <script type="module" defer src="public/components/slider/slider.js"></script>
  </head>
  <body>
    <!-- =========== START: HEADER =========== -->
    <div class="header">
