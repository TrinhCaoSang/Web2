<div class="container">
      ...
      <div class="admin__content">
        <div class="admin__content--body">
                      ...
                      <form class="admin__content--body__filter" id="product-filter-form">
                        ...
                        <div class="admin__content--body__filter--gr1">
                          ...
                          <div class="body__filter--idNumber" id="">
                            <p>Số lượng</p>
                            <input id="productCode" type="text" placeholder="Nhập số lượng sản phẩm" />
                          </div>

                          <div class="body__filter--idPrice" id="">
                            <p>Đơn giá</p>
                            <input id="productCode" type="text" placeholder="Nhập đơn giá sản phẩm" />
                          </div>
                        </div>
            ...
            <div class="admin__content--employee__content" id="staff">
              <div class="employee__content--top">
                ...
                <div class="button__container">
                  ...
                  <button class="employee__form--authority">Quyền</button>
          ...
          <!--Đơn hàng-->
          <div class="admin__content--receipt__content" id="bill" >
              ...
              <h1 class="bill__title">QUẢN LÝ ĐƠN HÀNG</h1>
                    ...
                    <table>
                      ...
                      <tr>
                        ...
                        <th class="text__align--left" style="text-decoration: underline;color: rgb(115, 198, 0);" onclick="show_bill()">Xem chi tiết</th>
